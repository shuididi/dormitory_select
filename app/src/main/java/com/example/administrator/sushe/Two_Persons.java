...
public class Two_Persons extends Activity implements View.OnClickListener{
    private TextView mName, mStuNum, mSex;
    private EditText mstu1id1,mcode1;
    private Button mBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.two_persons);
...
//        this.finish();//关闭此页面
        ...
        if (TextUtils.isEmpty(stu1.trim()) || TextUtils.isEmpty(v1cd.trim())){
            ...
            //tring xh = ((User)getApplication()).getStudentid();
            //创建map类
