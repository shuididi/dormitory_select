...
public class Three_Persons extends Activity implements View.OnClickListener{
    private TextView mName, mStuNum, mSex;
    private EditText mstu1id1,mcode1,mstu1id2,mcode2;
    private Button mBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.three_persons);
