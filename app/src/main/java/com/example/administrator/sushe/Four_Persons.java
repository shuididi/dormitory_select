...
public class Four_Persons extends Activity implements View.OnClickListener{
    private TextView mName, mStuNum, mSex;
    private EditText mstu1id1,mcode1,mstu1id2,mcode2,mstu1id3,mcode3;
    private Button mBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.four_persons);


        mStuNum = (TextView) findViewById(R.id.stuNum);
        mName = (TextView) findViewById(R.id.name);
        mSex = (TextView) findViewById(R.id.sex);
        mstu1id1= (EditText) findViewById(R.id.username1);
        mcode1= (EditText) findViewById(R.id.password1);
        mstu1id2= (EditText) findViewById(R.id.username2);
        mcode2= (EditText) findViewById(R.id.password2);
        mstu1id3= (EditText) findViewById(R.id.username3);
        mcode3= (EditText) findViewById(R.id.password3);
    ...
    public void onClick(View view) {
        String studentid = ((User)getApplication()).getStudentid();
        final String stu1 = mstu1id1.getText().toString();
        final String v1cd = mcode1.getText().toString();
        final String stu2 = mstu1id2.getText().toString();
        final String v2cd = mcode2.getText().toString();
        final String stu3 = mstu1id3.getText().toString();
        final String v3cd = mcode3.getText().toString();
        String  build= ((User)getApplication()).getBuilding();
